...
try
{
	categoryStage = new AnimationStage('stage_block_wrapper', 'cat_stage', 'category-template');
	...
	categoryStage.onElementClick = function(animationStage) {
		animationStage.animateExit(500, function() {
			try {
					$('#search').show();
					currentView = CURRENT_VIEW_PRODUCT;
					productStage.on();
					categoryStage.off();
					productStage.animateEntrance(500, function() {
						$('#category').hide();
	...
	productStage = new AnimationStage('stage_block_wrapper', 'prod_stage', 'product-template');
	...
	$(document).ready(function() {
		try
		{
			...
			addProduct('lenovo_y510p.1.jpg', '4', 'Lenovo', 'Y510p-59389485', 'Includes Veriface (facial reconigition)', '2099', '2099', '2099','Windows 8  ', '8 GB', 'Intel® Core™ I7-4700MQ Processor', '3.4GHz', '1TB   ', 'Nvidia® GeForce® GT750M ', ' 2GB VRAM (SLI)','LCD', '15.6"');
			addProduct('lenovo_flex_14.1_1.jpg', '5', 'Lenovo', 'Flex14-59392141', 'If you think a convertible notebook is out of your price range, think again. The Lenovo Flex 14 is a unique, thin and light, dual-mode laptop that flips 300 degrees from laptop to stand mode. Its a perfect way to enjoy movies on the go or make the most of touchscreen applications.', '1199', '999', '1199','Windows 8  ', '4 GB', 'Intel® Core™ i7-4500U Processor', '2.6GHz', '500GB  ', 'Nvidia® GeForce® GT720M ', '2GB VRAM','LCD', '14.0"');
			addProduct('acer_e1.jpg', '6', 'Acer', 'Model: E1-421-21804G50Mn', 'With the Aspire E Series, everyday activities like web browsing, communicating and playing videos are effortless with Intel® or AMD processing. NVIDIA® or AMD graphics deliver fine visual detail. Plenty of memory means you can launch applications quickly, and a large hard drive provides more space for your media.', '699', '695', '680','Windows 8  ', '4 GB', 'AMD Dual Core E2-1800M APU ', ' 1.70GHz', '500GB HDD', 'AMD Radeon™ HD6320 (Integrated)', '','LCD', '14.0"');
			addProduct('sony_vaio_fit_15e.1_1.jpg', '7', 'Sony', 'VAIO® Fit 15 SVF-15A15CGB', 'VAIO® Fit 15 is great to use for business and home entertainment. The 15" Full HD screen with touch operation displays vivid, clear images. A hairline finished aluminium body and simple design produce a high-class look. The Hybrid HDD combines high speed performance with a large capacity HDD.', '1699', '1899', '1999','Windows 8 64 bit ', '8 GB', 'Intel® Core™ i7-3537U Processor', '2 GHz with Turbo Boost up to 3.10 GHz', '750 GB + NAND FLASH Memory 8 GB', 'NVIDIA® GeForce® GT 735M with NVIDIA® Optimus™ technology', ' 2GB DDR3 VRAM','Touch', '15.5"');
			addProduct('hp_envy_15.1_1.jpg', '8', 'HP', 'ENVY TouchSmart 15-j005TX', 'Standout performance. Inside and out.', '1599', '1599', '1599','Windows 8', '8 GB', '4th generation Intel® Core™ i7-4700MQ Processor', '2.4GHz', '750GB', 'NVIDIA® GeForce® GT 740M switchable Graphics ', '2G DDR3 VRAM','Touch', '15.6 "');
			addProduct('hp_dv6.2.jpg', '9', 'HP', 'DV6-7309TX', 'With full HD Screen', '1699', '1699', '1699','Windows 8', '8 GB', 'Intel® Core™ i7-3630QM Processor', '2.4GHz', '1TB HDD', 'Nvidia® Geforce® GT650M ', '2GB DDR5','Full HD', '15.6"');
			addProduct('toshiba_p50.1.jpg', '10', 'Toshiba', 'Satellite® P50-A100X', 'Powerful yet portable, the entertainment-optimized Satellite® P50 series laptop provides an elegant touchscreen1 PC experience with Windows® 8. With a 15.6” diagonal, Full HD, TruBrite® display, Harman Kardon® speakers, modernized design, an exquisite, frameless, LED-backlit keyboard and many other premium features, this laptop is ideal for work or play.', '1699', '1699', '1699','Windows 8 Premium with Chinese OS', '8 GB', 'Intel® Core™ I7-4700QM', '2.4GHz', '1TB', 'Nvidia® Geforce® GT740M', '4GB VRam','Touch', '15.6"');
				...
				try {
				  // The currently selected value of the slider
					...
					sliderTimeOut = setTimeout(function() {
						  ...
						  productStage.animateFilter(500);
					}, 100);
			...
			$('#nav-home').click(function() {
				if (currentView == CURRENT_VIEW_PRODUCT) {
					...
					$('#category').show();
					productStage.animateExit(500, function() {
						$('#search').hide();
			...
			categoryStage.animateEntrance(500);
